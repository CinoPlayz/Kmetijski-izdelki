...
if(isset($_POST['tabela'])){
    ...
    if(isset($body) && !empty($body)){
        ...
        header("location: Dodajanje.php?tabela=$tabela&napaka=$vrnjenosporocilo");
        exit;
    }
    else{
        unset($_SESSION['temp']);
        header("location: Branje.php?tabela=$tabela&uspeh=dodano");
        exit;
    }
    ...
    <body>
        <div class="vse">
            ...
            <div class="vsebina">
                <div>
                    <div class="formdiv">
                        <form method="post" action="Dodajanje.php">                            
                            <div class="formvnosi">
