...
if(isset($_POST['tabela'])){
    ...
    $urldel = str_replace("Admin/SpreminjanjeAdmin.php", "api/spreminjanje.php", $povnaslov) . "?tabela=" . urlencode($tabela);;
    ...
    if(isset($body) && !empty($body)){
        ...
        header("location: SpreminjanjeAdmin.php?tabela=$tabela&$primaryKey=$primaryPodatek&napaka=$vrnjenosporocilo");
        exit;
    }
    else{
        unset($_SESSION['temp']);
        header("location: BranjeAdmin.php?tabela=$tabela&uspeh=spremenjeno");
        exit;
    }
    ...
    <body>
        <div class="vse">
            ...
            <div class="vsebina">
                <div>
                    <div class="formdiv">
                        <form method="post" action="SpreminjanjeAdmin.php">                            
                            <div class="formvnosi">
